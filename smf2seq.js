...
// # Read and parse SMF
var midi_blob = fs.readFileSync("song.mid");
var t = "";
...
// # Generate sin table
var file = "// Generated by smf2seq.js\n";
...
file += "PROGMEM const unsigned char sine[] = {"+sine_sample.join(",")+"};\n";
...
console.log("Using memory: "+(notes.length*3+sine_sample_size));
